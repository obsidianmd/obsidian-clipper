...
body:
    - type: checkboxes
      attributes:
          ...
          description: Please review [Troubleshooting instructions](https://github.com/alexrosepizant/clipper-for-appflowy/blob/main/docs/Troubleshoot%20Web%20Clipper.md) before opening an issue.
          options:
...
https://github.com/alexrosepizant/clipper-for-appflowy/blob/main/docs/Troubleshoot%20Web%20Clipper.md

**Version (please complete the following information):**

- OS: [e.g. Windows]
- Browser [e.g. Chrome, Firefox]
- Web Clipper version: [e.g. 0.1.0]
- AppFlowy version: [e.g. 0.11.14]
